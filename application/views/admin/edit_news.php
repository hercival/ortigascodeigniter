    ...
    <div class="col-md-12">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo site_url('administrator/edit_news')?>" method="POST" class="form-horizontal" id="add-block-form">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select class="form-control" name="featured">
                                     <option value="0" <?php echo ($results->featured == 0 ? 'selected="selected"' : '');?>>No</option>
                                    <option value="1" <?php echo ($results->featured == 1 ? 'selected="selected"' : '');?>>Yes</option>
                                </select>
                            </div>
                        </div>

			...
			<div class="modal-body">
				...
				<div class="tab-content clearfix">
					<div class="tab-pane active fade in" id="upload">
						<!-- Start Form Upload -->
						<?php //echo form_open_multipart('administrator/do_upload', array('class' => 'image-form form-horizontal'));?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 fileupload">
                                            <span class="btn btn-success fileinput-button">
                                                ...
                                                <input type="file" accept = "image/*" class = "form-control file-select" name="uploadfile" size="20" id="img-select"/><br />
                                            </span>

                                            <div class = "upload-messages m-t-10"></div>
                                        </div>
                                        <div id="img-container" class="img-preview pull-left">
                                            <img src="<?php echo base_url()?>includes/img/img-placeholder.png" class="img-thumbnail help-img">
                                        </div>
                                    </div>
                                </form>
						    </div>
				    ...
				    <div class="tab-pane fade" id="library">
                        ...
                        <div class="media-gallery">
                            <?php 
                                $uploads = config_item('uploads_loc');

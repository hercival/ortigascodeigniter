    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            <div class="panel-heading">
                <h4 class="panel-title">Tile With Description Module</h4>
            </div>
            ...
            <div class="panel-body">
               <?php if($this->session->flashdata('saved')): ?>
                ...
                <?php endif; ?>
                <center><img src="<?php echo base_url();?>includes/layout/caption-layout.png" alt="" class="img-responsive"></center>
                <p>&nbsp;</p>
                <form class="form-horizontal" name="demo-form" action="<?php echo site_url('tile/modify/'.$mod_details->id)?>" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" id="desc" class="form-control" placeholder="Short Description">
                            </div>
                            <div class="col-md-3">    
                             ...
                             <?php foreach($main_details->item as $item) { ?>
                                <?php $detail = explode('::', $item); ?>
                                  <tr class="removable-wrap">
                                    ...
                                    <td>
                                      <?php echo $detail[1]; ?>
                                      <input type="hidden" name="item[]" value="<?php echo $detail[0].'::'.$detail[1].'::'.$detail[2].'::'.$detail[3]; ?>">
                                    </td>
                                    <td>
                                         <?php echo $detail[3]; ?>
                                    </td>
...
<script>
    ...
    $("#add-to-list").click(function(){
        ...
        var tmp =   '<tr class="removable-wrap">' +
                    ...
                    '<td>'+title+'<input type="hidden" name="item[]" value="'+image_name+'::'+title+'::'+link+'::'+desc+'"></td>'+
                    '<td>'+desc+'</td>'+
                    '<td>'+link+'</td>'+

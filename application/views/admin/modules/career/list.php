    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            <div class="panel-heading">
                <h4 class="panel-title">Career Module</h4>
            </div>
            ...
            <div class="panel-body">
               <?php if($this->session->flashdata('saved')): ?>
                ...
                <?php endif; ?>
                <center><img src="<?php echo base_url();?>includes/layout/careers-layout.png" alt="" class="img-responsive"></center>
                <p>&nbsp;</p>
                <form class="form-horizontal" name="demo-form" action="<?php echo site_url('career/modify/'.$mod_details->id)?>" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="listcount" id="listcount" class="form-control" placeholder="Count of News" value="<?php if(isset($main_details)){ echo $main_details->listcount;}?>">
                            </div>
                        </div>
                        <div class="form-group">

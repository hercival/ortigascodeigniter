                ...
                <table class="table table-striped table-bordered" data-tbname="news">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>administrator/delete_career/<?php echo $row->id?>" class="btn btn-icon btn-circle btn-danger" title="Delete"><i class="fa fa-times"></i></a>
                                    <a href="<?php echo base_url(); ?>administrator/edit_career/<?php echo $row->id?>" class="btn btn-icon btn-circle btn-success" title="Edit News" rel="<?php echo $row->id?>"><i class="fa fa-pencil"></i></a>
                            </td>
                        </tr>

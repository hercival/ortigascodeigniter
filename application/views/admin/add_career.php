    ...
    <div class="col-md-12">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo site_url('administrator/add_career')?>" method="POST" class="form-horizontal" id="add-block-form">
                    <fieldset>
                        ...
                        <div class="col-md-3 col-sm-3 col-md-offset-6">
                            ...
                            <button type="submit" class="btn btn-primary pull-right">Save Career</button>
                        </div>
                    </fieldset>
                    </fieldset>
                </form>

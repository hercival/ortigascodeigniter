...
<!--        <script src="<?php echo base_url(); ?>includes/js/jquery.js"></script>-->
        ...
        <script src="<?php echo base_url(); ?>includes/js/queryloader2.min.js" type="text/javascript"></script>
<!--
        <script type="text/javascript">
            window.addEventListener('DOMContentLoaded', function() {
                QueryLoader2(document.querySelector("#main-wrapper"), {
                    barColor: "#2aa25a",
                    backgroundColor: "#fff",
                    percentage: false,
                    barHeight: 2,
        ...
        <div class="navbar-collapse collapse">
           <?php echo module_menu(1,'topmenu');?>
            <div class="input-group stylish-input-group">
                <a class="icon-margin" href="https://www.facebook.com/OrtigasPH" target="_blank">
...
<!-- Body Starts Here -->
    <?php module_position('position-1',$page_details);?>
    
    <?php module_position('position-2',$page_details);?>
     
    <?php module_position('position-3',$page_details);?>
    
    <?php module_position('position-4',$page_details);?>
    
    <?php module_position('position-5',$page_details);?>
    
    <?php module_position('position-6',$page_details);?>
    
    <?php module_position('position-7',$page_details);?>
    
    <?php module_position('position-8',$page_details);?>
    
    <?php module_position('position-9',$page_details);?>
    
    <?php module_position('position-10',$page_details);?>
...
<!-- Maps -->
        <section class="map-section">
            <div class="col-lg-3 overlay-tab-maps">
                ...
                <p>Ortigas Avenue, San Antonio, Pasig City</p>
                <p>Metro Manila 1600 Philippines</p>
                <br>
            ...
            <script type='text/javascript'>function init_map(){var myOptions = {zoom:16,center:new google.maps.LatLng(14.5885169,121.0633686),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(14.5885169,121.0633686)});infowindow = new google.maps.InfoWindow({content:'<strong>Ortigas & Company</strong><br>9th Floor, Ortigas Building, Ortigas Avenue, San Antonio, Pasig City, Metro Manila<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);
            </script>
            </div>
        </section>  
        ...
        <div id="loader">
            <div id="loading">
                <div id="wrapper-loading">
                    <img src="<?php echo base_url();?>loading.gif">
                </div>
            </div>
        </div>
        <script type="text/javascript">

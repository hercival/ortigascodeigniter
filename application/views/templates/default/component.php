...
<!-- Body Starts Here -->
    <?php if(isset($page_details)){module_position('position-1',$page_details);}?>
    <?php $this->load->view('components/'.$components.'/'.$layout,  $details);?>
    <?php if(isset($page_details)){module_position('position-2',$page_details);}?>
...
<!-- Maps -->
        ...
        <!--script src="<?php echo base_url(); ?>includes/js/jquery.carousel.fullscreen.js"></script-->

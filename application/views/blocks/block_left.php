			...
			<section id="<?=@$section_id?>" class="block-section <?=@$block_theme . ' ' . @$div_class . ' ' . @$height?> section block-left" <?php if($url != ''): ?> style="background: url(<?php echo $url; ?>) no-repeat; background-size: cover; background-position: center;" <?php endif; ?>>
				<div class="container">
					<div class="row">
						<div class="col-md-6 vcenter vcenter-y" style="float: right">
						...
						<div class="col-md-6 vcenter vcenter-y">
							<div class="vcenter-content">

<?php
        ...
        //$mcImageManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'].'/bbmp/includes/upload-files'; // absolute or relative from this script path, optional. 
        $mcImageManagerConfig['filesystem.path'] = '../../../../includes/upload-files'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../includes/upload-files'; // absolute or relative from this script path, required.

...
var options = {
    beforeSend: function(f){
        ...
        if(count_img >= 1){
            ...
            $(vars.msg_container).html('<img src = "'+get_base_url()+'includes/img/preloader.png" class = "loader" width="20" height="20" /> Please wait.. <span class="percent"></span>').css('display', 'inline-block');
        }
        vars.canPost = false;
    },
    complete: function(response){
        ...
        $(vars.uploaded_container).html($( '<span class="remove-photo glyphicon glyphicon-remove" aria-hidden="true"></span><img class="img-responsive" width="'+vars.img_preview_width+'" height="'+vars.img_preview_height+'" src="'+get_base_url()+'includes/uploads/'+res.file_name+'" data-image-filename="'+res.file_name+'" />')); 
